...
<head>
	...
	<title>Back End Development Course in Bilaspur Chhattisgarh</title>
</head>
<body>
	<main>
		...
		<section class="html-list">
			<div class="container-80">
				<div class="margin-tb">
                    <p class="fs-30 inline-block" >Back End Development Course Syllabus:</p>
                    <div class="margin-tb">
                        <h2 class="">Back End Devlopment</h2>
                        <div id="backCourse">
